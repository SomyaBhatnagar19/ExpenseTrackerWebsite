  ...
  return (
    <div className="bg-white shadow-md p-6 overflow-x-auto">
      ...
      <div className="flex justify-between items-center p-2">
        <span className="text-left text-lg font-semibold text-emerald-700 italic">Total Expense</span>
        <span className="text-right text-md font-bold text-emerald-700 italic">Rs. {totalExpense} /-</span>
        {totalExpense > 10000 && (
          <button
            type="button"
